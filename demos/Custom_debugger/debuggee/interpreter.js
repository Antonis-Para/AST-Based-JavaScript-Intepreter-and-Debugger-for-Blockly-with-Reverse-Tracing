...
var Interpreter = {
    ...
    "eval_bool_const" : function (node) {
        return node.value;
    },
    "eval_null_const" : function (node) {
        return node.value;
    },
    "eval_text_const" : function (node) {
        return node.value;
    },
    "eval_colour_const" : function (node) {
        return node.value;
    },
    ...
    "eval_var_decl" : function (node) {
        this.userVars[node.name] = undefined;
    },

    "eval_var" : function (node) {
